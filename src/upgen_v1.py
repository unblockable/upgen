...
def worst_protocol_settings() -> ProtocolSettings:
    ...
    fields["padding_length"] = {"length" : 4}
    ...
    handshake_pattern = HandshakePattern(key_patterns=pattern8)
...
def best_protocol_settings() -> ProtocolSettings:
    ...
    fields["padding_length"] = {"length" : 2}
    ...
    handshake_pattern = HandshakePattern(key_patterns=pattern3)
